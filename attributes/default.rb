...
default['postgresql']['max_replication_slots'] = '5'
default['postgresql']['max_wal_senders'] = '7'
default['postgresql']['wal_sender_timeout'] = '0' # disables timeout
default['postgresql']['idle_in_transaction_session_timeout'] = '0'
